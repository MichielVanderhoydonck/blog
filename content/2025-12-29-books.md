...
We have our metrics and the architecture, the last piece to our puzzle: the people.

In a recent interview Dr. Nicole Forsgren (author of Accelerate) introcduced a concept going beyond system performance: **Developer Experience**.
Next to the system, we need a way to measure the human.

## From DORA to SPACE

It's easy to resort to lines of code or hours worked when measuring "productivity." These are half baked and we should aim to truly understand engineering health. For this the **SPACE Framework** comes in:
- Satisfaction
- Performance
- Activity
- Communication
...
If AI helps you generate more code, but that code also requires more time to review and debug, you haven't gained speed—you've just created technical debt faster. Tacho points out a "Satisfaction Paradox": if AI automates the "fun" part (writing the initial logic) but leaves developers with the "toil" (fixing the subtle bugs the AI introduced), job satisfaction—and ultimately performance—will plummet.
...
A core finding that resonates is: **Developer happiness is a leading indicator of software performance**.

You've been there, having to wait 20 minutes for your build, losing your "flow state." Your efficiency tanks and so does your satisfaction, in the end your DORA metrics also suffer (deployment frequency). Focussing on **DevEx**, reducing cognitive load, speeding feedback loops and removing friction we regain our developer happiness and make business faster.
