...
Having worked on this since the post's original date, I noticed our ports package feels a bit wastefull and we can likely get it cleaner and leaner.
With some further reading I found that the folks at Three Dots Labs take an interresting approach to this, have a look at [their blog post](https://threedots.tech/post/introducing-clean-architecture/)!  
They state:
>    Our ports are Hexagonal Architecture’s Primary Adapters.  
>    Our adapters are Hexagonal Architecture’s Secondary Adapters.  

Let's combine that thought with weeding out some intermediate layers.
...
Each domain (“errorbudget”, “burnrate”) has its own sibling folders in **domain/** and **service/**. This keeps all responsibilities grouped by domain, not by layer.
...
- Extract your Ports and perhaps encapsulate these in the Services
